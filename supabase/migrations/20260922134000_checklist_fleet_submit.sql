-- =============================================================================
-- Etapa 12 — envio do checklist (§51, §52, §57)
--
-- Uma transação: cabeçalho, respostas, resumo por cluster e o evento de
-- conciliação. Se qualquer parte falhar, nenhuma existe — e é isso que impede
-- um checklist "concluído" sem respostas.
--
-- A execução NASCE 'draft' e só vira 'submitted' no update final. Não é
-- detalhe: o gatilho de selagem recusa alteração de execução já enviada, e
-- nascer 'submitted' faria a própria rotina bater na própria trava ao gravar os
-- contadores.
-- =============================================================================
